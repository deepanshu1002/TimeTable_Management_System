  ...
  Welcome to the Admin Dashboard
    ...
    <div class="container">
        ...
        <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1 text-center justify-content-center px-xl-6 aos-init aos-animate" data-aos="fade-up">
            ...
            <div class="col my-3" >
                <button onClick={()=> navigate('/validuser')} className='border-0 shadow-none' style={{backgroundColor:'white'}}>
            ...
            <div class="col my-3">
            <button onClick={()=>navigate('/manageleaves')} className='border-0 shadow-none' style={{backgroundColor:'white'}}>
                <div class="card border-hover-primary hover-scale">
                    <div class="card-body">
                        <div class="text-primary mb-5">
            ...
            <div class="col my-3">
            <button onClick={()=>navigate('/managesubject')} className='border-0 shadow-none' style={{backgroundColor:'white'}}>
                <div class="card border-hover-primary hover-scale">
                    <div class="card-body">
                        <div class="text-primary mb-5">
            ...
            <div class="col my-3">
            <button onClick={()=>navigate('/managedepartment')} className='border-0 shadow-none' style={{backgroundColor:'white'}}>
                <div class="card border-hover-primary hover-scale">
                    <div class="card-body">
                        <div class="text-primary mb-5">
            ...
            <div class="col my-3">
            <button onClick={()=>navigate('/managelab')} className='border-0 shadow-none' style={{backgroundColor:'white'}}>
                <div class="card border-hover-primary hover-scale">
                    <div class="card-body">
                        <div class="text-primary mb-5">
            ...
            <div class="col my-3">
            <button onClick={()=>navigate('/manageclassroom')} className='border-0 shadow-none' style={{backgroundColor:'white'}}>
                <div class="card border-hover-primary hover-scale">
                    <div class="card-body">
                        <div class="text-primary mb-5">
            ...
            <div class="col my-3">
            <button onClick={()=>navigate('/ratings')} className='border-0 shadow-none' style={{backgroundColor:'white'}}>
                <div class="card border-hover-primary hover-scale">
                    <div class="card-body">
                        <div class="text-primary mb-5">
            ...
            <div class="col my-3">
            <button className='border-0 shadow-none' style={{backgroundColor:'white'}}>
                <div class="card border-hover-primary hover-scale">
                    <div class="card-body">
                        <div class="text-primary mb-5">
