        ...
        <div>
          <div className="main-content">
            <Routes>
              ...
              <Route
                path="/timetablemetadata"
                element={<TimeTableMetadata />}
              />

              <Route path="/addlecturedata" element={<AddLectureData />} />

              <Route
                path="/getlecturedetails"
                element={<GetLectureDetails />}
              />
              ...
              <Route
                path="/checkteacherrating"
                element={<CheckTeacherRatings />}
              />
              <Route
                path="/teacherratings/:subjectId/:date"
                element={<TeacherRatings />}
              />
              <Route
              ...
              <Route
                path="/subjectweeklyhours/:deptId/:date"
                element={<SubjectWeeklyHours />}
              />

              <Route
                path="/timetableadmin/:deptId/:date"
                element={<ViewTimetableAdmin />}
              />

              <Route
                path="/timetableteacher/"
                element={<ViewTimetableTeacher />}
              />
